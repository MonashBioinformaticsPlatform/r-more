...
Packages are the next step up from sourcing .R files. They let you write code that other people can install and load with `library`. Packages generally contain documentation for all functions, and one or more vignettes describing how to use the package.
