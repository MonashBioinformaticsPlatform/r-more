...
To start off, we're going to create a blank app, to show what is the bare minimum to create a Shiny app. Create a `demo` folder in your ShinyApps folder and then name a new R script `app.R`. In app.R, type:
